export const bannerProducts = [
  {
    ...
    details: [
      ...
      "This product is solely the front facade of your house. If you would like your full house printed please see our product named 3D Printed Your House - Full House!",
      "After purchasing, you will be redirected to link where you can include any images and personalizations you would like",
      "This is a completely custom service, so you are paying for modeling of the structure, printing, and for regular updates and excellent communication.",
      ...
      "**Due to the labor involved in creating these model houses, there are NO refunds or returns. I will however work with you on any issues you may have with your order**",
    ],
    images: [
      "src/images/frontImages/pic1.png",
      "src/images/frontImages/pic2.png",
      "src/images/frontImages/pic3.png",
      "src/images/frontImages/pic4.png",
      "src/images/frontImages/pic5.png",
      "src/images/frontImages/pic6.png",
    ],
  ...
  },
  {
    ...
    details: [
      "This is a 3D Printed Custom House model service.",
      "This product is for the entirety of your house.",
      "Model size varies. 10in maximum in all directions.",
      "After purchasing, you will be redirected to link where you can include any images and personalizations you would like",
      "If the model includes a higher level of detail, we will message you a quote with a final price. Prices vary from $250 - $350.",
      ...
      "To personalize your house with text underneath, please add what you would like personalized 100-character limit.",
      "The printed houses are in color. However, colors are limited. We will send you the renderings of the house with the exact tone of colors that will be used. You can approve the colors at this step in the process.",
      "**Due to the labor involved in creating these model houses, there are NO refunds or returns. I will however work with you on any issues you may have with your order**",
    ],
    images: [
      "src/images/fullImages/pic1.png",
      "src/images/fullImages/pic2.png",
      "src/images/fullImages/pic3.png",
    ],
  ...
  {
    name: "3D Printed Business Card Holder",
    price: 15,
    shortDetails: [
    ...
    images: [
      "src/images/accessoryImages/acc1.png",
      "src/images/accessoryImages/acc2.png",
      "src/images/accessoryImages/acc3.png",
      "src/images/accessoryImages/acc4.png",
      "src/images/accessoryImages/acc5.png",
    ],
